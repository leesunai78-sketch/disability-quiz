...
const QUIZ_DATA = {
  ...
  harassment: [
    ...
    { id:10, category:'법적 처벌', categoryColor:'#b45309', type:'ox',
      ...
      answer:'O', explanation:'남녀고용평등법 제14조 제6항: 신고자·피해자에 대한 불이익 처우는 3년 이하 징역 또는 3,000만 원 이하 벌금에 해당합니다.' },
    { id:11, category:'법적 처벌', categoryColor:'#b45309', type:'multiple',
      question:'직장내 성희롱 예방교육을 연 1회 실시하지 않은 사업주에게 부과되는 제재는?',
      options:['별도 제재 없음','100만 원 이하 과태료','300만 원 이하 과태료','1년 이하 징역'],
      answer:'300만 원 이하 과태료', answerIndex:2,
      explanation:'남녀고용평등법 제39조에 따라 예방교육 미실시 시 300만 원 이하 과태료가 부과됩니다.' },
